      ...
      <main className="relative">
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.08]">
            <div
              className="absolute top-20 left-[10%] text-[#ff6b4a] text-6xl rotate-12 animate-pulse"
              style={{ animationDelay: "0s" }}
            >
              ♪
            </div>
            <div
              className="absolute top-40 right-[15%] text-[#2aa6a1] text-5xl -rotate-12 animate-pulse"
              style={{ animationDelay: "1s" }}
            >
              ♫
            </div>
            <div
              className="absolute bottom-32 left-[20%] text-[#ffb347] text-7xl rotate-45 animate-pulse"
              style={{ animationDelay: "2s" }}
            >
              ♬
            </div>
            <div
              className="absolute top-1/2 right-[25%] text-[#ff6b4a] text-4xl -rotate-45 animate-pulse"
              style={{ animationDelay: "1.5s" }}
            >
              ♪
            </div>
            <div
              className="absolute bottom-20 right-[10%] text-[#2aa6a1] text-6xl rotate-12 animate-pulse"
              style={{ animationDelay: "0.5s" }}
            >
              ♫
            </div>
            <div
              className="absolute top-1/3 left-[5%] text-[#ffb347] text-5xl rotate-90 animate-pulse"
          ...
          <div
            className="absolute bottom-0 left-6 h-[300px] w-[300px] rounded-full bg-[#2aa6a1]/25 blur-[120px] animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 right-1/4 h-[200px] w-[200px] rounded-full bg-[#ffb347]/20 blur-[100px] animate-pulse"
            style={{ animationDelay: "2s" }}
          />
          ...
          <div
            className="absolute top-40 right-32 h-2 w-2 rounded-full bg-[#ff6b4a]/40 animate-ping"
            style={{ animationDelay: "0.5s" }}
          />
          <div
            className="absolute bottom-40 left-32 h-2 w-2 rounded-full bg-[#2aa6a1]/40 animate-ping"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute top-1/2 left-1/4 h-1.5 w-1.5 rounded-full bg-[#ffb347]/50 animate-ping"
            style={{ animationDelay: "2.5s" }}
          />
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/80 sm:text-xl">
                Convites certeiros, ranking que te coloca em evidência e gigs
                chegando mais rápido. Entrou, já começa a chegar proposta boa.
              </p>
              ...
              {socialProofMusicians.length > 0 && (
                <div className="flex flex-wrap items-center gap-4 text-sm text-foreground/70">
                    ...
                    {socialProofMusicians.slice(0, 4).map((musician: any) => (
                      ...
                      >
                        <AvatarImage
                          ...
                          alt={musician.display_name || "Músico"}
                        />
                        <AvatarFallback>
                          {musician.display_name?.slice(0, 2)?.toUpperCase() ||
                            "CM"}
                        </AvatarFallback>
                      </Avatar>
                    ))}
                  ...
                  <span>
                    +{formatCompact(stats.totalUsers || 0)} músicos já fechando
                    show agora
                  </span>
                </div>
              )}
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr]">
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/75">
                Você abre o app e já vê convite, meta do dia e o que fazer
                agora. Resultado: mais show fechado e menos enrolação.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {features.map((feature) => (
                <Card
                  key={feature.title}
                  className="border border-white/70 bg-white/90 shadow-sm"
                >
                  <CardContent className="space-y-3 p-5">
          ...
          <div className="grid gap-8 rounded-3xl border border-white/70 bg-white/80 p-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-4">
              ...
              <p className="text-base text-foreground/70">
                Tudo organizado por status. Baixa o calendário e joga no
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {socialProofMusicians.length === 0 ? (
              ...
              socialProofMusicians.map((musician: any) => {
                const instruments =
                  musician?.musician_profiles?.[0]?.instruments || [];
        ...
        <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-gradient-to-br from-[#ff6b4a] via-[#ffb347] to-[#2aa6a1] p-8 text-white shadow-lg lg:p-12">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Button
                className="bg-white text-[#2aa6a1] hover:bg-white/90"
                asChild
              >
                <Link href="/signup">
                  Quero entrar agora
