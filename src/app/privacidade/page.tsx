...
export const metadata = {
  ...
  description:
    "Política de privacidade e proteção de dados da plataforma Chama o Músico",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            <section>
              ...
              <p>
                O Chama o Músico (&quot;nós&quot;, &quot;nosso&quot; ou
                &quot;plataforma&quot;) está comprometido em proteger a
                privacidade e segurança dos dados pessoais de nossos usuários.
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>
                  Para músicos: instrumentos, gêneros musicais, experiência
                </li>
                <li>
                  Para contratantes: informações sobre trabalhos publicados
                </li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                <li>
                  <strong>Com outros usuários:</strong> Informações do seu
                  perfil são visíveis para outros usuários da plataforma
                ...
                <li>
                  ...
                  plataforma (hospedagem, análise, etc.)
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                para proteger suas informações pessoais, incluindo criptografia,
                controles de acesso e monitoramento regular. No entanto, nenhum
                sistema é 100% seguro, e não podemos garantir segurança
                absoluta.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Mantemos suas informações pessoais enquanto sua conta estiver
                ativa ou conforme necessário para fornecer nossos serviços.
                Podemos reter certas informações mesmo após o encerramento da
                conta para cumprir obrigações legais ou resolver disputas.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>
                  <strong>Exclusão:</strong> Solicitar exclusão de suas
                  informações pessoais
                </li>
                <li>
                  <strong>Portabilidade:</strong> Solicitar portabilidade dos
                  seus dados
                </li>
                <li>
              ...
              <p className="mt-4">
                ...
                ou pelo email privacidade@chamaomusico.com.br.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                conteúdo. Você pode gerenciar preferências de cookies através
            ...
            <section>
              ...
              <p>
                Nossa plataforma é destinada a usuários com 18 anos ou mais. Não
                coletamos intencionalmente informações de menores de 18 anos. Se
            ...
            <section>
              ...
              <p>
                ...
                Recomendamos que você leia as políticas de privacidade de
            ...
            <section>
              ...
              <p>
                ...
                plataforma ou por email. Recomendamos que você revise esta
            ...
            <section>
              ...
              <p>
                ...
                através do email dpo@chamaomusico.com.br.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Ao usar nossa plataforma, você consente com a coleta e uso de
