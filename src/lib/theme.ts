...
export const themes: Record<ThemeName, Theme> = {
  default: {
    name: 'default',
    label: 'Padrão',
    description: 'Laranja, Roxo e Azul',
    colors: {
      background: '0 0% 100%',
      ...
      accent: '262.1 83.3% 57.8%', // purple-500 #a855f7
    ...
    preview: {
      bg: 'bg-gradient-to-br from-orange-50 via-purple-50 to-blue-50',
      primary: 'bg-gradient-to-r from-orange-500 to-purple-500',
      secondary: 'bg-gradient-to-r from-purple-500 to-blue-500',
    },
  },
  ocean: {
    name: 'ocean',
