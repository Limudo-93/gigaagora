...
console.log('- A chave PÚBLICA pode ser usada no código do cliente (NEXT_PUBLIC_)');
console.log('- VAPID_SUBJECT deve ser um email válido (mailto:seu-email@exemplo.com)');
