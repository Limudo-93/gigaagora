...
-- Política para permitir upload de flyers (qualquer usuário autenticado pode fazer upload)
-- O caminho é: gig-flyers/{userId}/{fileName}
...
WHERE schemaname = 'storage' 
  ...
  AND policyname LIKE '%gig flyers%';
